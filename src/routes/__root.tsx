...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Trần Gia Bảo — Landscape Photographer" },
      { name: "description", content: "Fine art landscape photography portfolio of Trần Gia Bảo." },
      { name: "author", content: "Trần Gia Bảo" },
      { property: "og:title", content: "Trần Gia Bảo — Landscape Photographer" },
      { property: "og:description", content: "Fine art landscape photography portfolio of Trần Gia Bảo." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@giabaophotography" },
    ],
    links: [
